...
> 作者因追求生产力转型及解决通勤负担，决定弃用沉重的Windows游戏本，购入MacBook Air M4。核心动机是从消遣性游戏转向编程开发与视频创作，利用Mac轻便（1.24kg）、长续航（18h）及屏幕色准高的硬件优势，满足校内移动办公需求。macOS系统在权限管理上具备更强的隐私安全性，且通过Homebrew包管理器兼顾了类Linux的开发效率。作者通过卖旧换新确立了以Mac为核心的学习与项目开发体系，并总结了环境搭建的初步经验。
