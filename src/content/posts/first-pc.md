...
> 作者将极光X笔记本更换为MacBook后，因系统适配及外设兼容问题迅速售出并购入暗影精灵11，后因系统不稳定决定转向台式机。通过朋友提供的Intel板U及自购配件完成首次DIY组装。装机中克服了内存单边卡扣、水冷接线、螺丝柱固定及冷排安装位置等技术困难。最终整机配置为i5-13600K与RTX 4070 Ti Super，经CPU-Z、甜甜圈及AIDA64等软件测试，各项性能指标表现稳定。
